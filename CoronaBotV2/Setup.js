...
let sqlcmdtableMorgenpost = "CREATE TABLE IF NOT EXISTS `region` (`TimeStamp` varchar(255) ,`Bundesland` varchar(255), `Ort` varchar(255), `Quelle` varchar(255), `QuelleURL` varchar(255), `confirmed` varchar(255), `recovered` varchar(255), `deaths` varchar(255), `population` varchar(255), `time` TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, PRIMARY KEY (`Ort`, `Bundesland`));"
